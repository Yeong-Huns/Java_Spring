 ...
 <jsp:include page="../common/header.jsp"/>
  ...
  <div class="panel panel-default">
    	...
    	<input type="hidden" name="memId" id="memId" value="${mvo.memId}"/>
    		<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
    			...
    			<tr>
    				...
    				<td colspan="2"><input  id="memAge" name="memAge" type="number" class="form-control" maxlength="20" placeholder="나이를 입력하세요." value="${mvo.memAge}"/></td>
    			</tr>
    			<tr>
    				...
    				<td colspan="2"><div class="form-group" style="text-align:center; margin:0 auto">
    					<div class="btn-group" data-toggle="buttons">
							<label class="btn btn-success <c:if test="${mvo.memGender eq '남자'}"> active</c:if>">
								<input name="memGender" type="radio" autocomplete="off" value="남자"
								<c:if test="${mvo.memGender eq '남자'}"> checked</c:if>/>남자
							</label>
							<label class="btn btn-warning <c:if test="${mvo.memGender eq '여자'}"> active</c:if>">
								<input name="memGender" type="radio" autocomplete="off" value="여자"
    			...
    			<tr>
    				...
    				<td colspan="2"><input value="${mvo.memEmail}" id="memEmail" name="memEmail" type="email" class="form-control" maxlength="20" placeholder="이메일을 입력하세요."/></td>
    			</tr>
				<!--권한 출력-->
				<tr>
	...
	<div id="myMessage" class="modal fade" role="dialog">
     ...
     <div class="panel-footer">Yeong_Huns_SpringMVC06</div>
  </div>
</div>
